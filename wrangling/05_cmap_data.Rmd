...
c(
  file.path("..", "wrangled", "cmap_perturbation_meta.csv.gz"),
  file.path("..", "wrangled", "cmap_instance_meta.csv.gz"),
  file.path("..", "wrangled", "cmap_signature_meta.csv.gz"),
  file.path("..", "wrangled", "cmap_gene_meta.csv.gz")
) %>%
